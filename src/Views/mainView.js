function generateMarkup() {
  ...
  <section class="hero container section">
    <div class="hero-title">
      ...
      <!--  <div class="arrow-btns">
        <button class="arrow-btn-left prevButton">
          <svg
        ...
        <button class="arrow-btn-right active-btn nextButton">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div class="hero-counter">
        <span class="counter-current"
          >0 <span class="counter-slash">/</span>
          <span class="counter-total">02</span><br />1</span
        >
      </div>-->
    </div>
    <!-- IMAGE  -->
    <div class="hero-img">
      <img src="/about-1.png" alt="Home image" loading="lazy" />
    ...
    <!-- <div class="hero-img">
      <img src="/second-slide.jpg" alt="Home image" loading="lazy" />
      <div class="btn-container">
        <button class="btn project-btn">
          View project
          <svg
  ...
  <section class="section container main-focus">
    ...
    <div class="focus-wrapper">
      ...
      <div class="focus-first">
        ...
        <p class="focus-description__first">
      ...
      <div class="focus-second">
        ...
        <div class="">
          <p class="focus-description__second">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
  ...
  <section class="section container our-projects">
    ...
    <div class="projects-wrapper">
      <div class="project-img1">
        ...
        <img src="/project-1.jpeg" alt="project-1" loading="lazy" />
        <div class="project1-text">
          <h2 class="project1-title">Sample Project</h2>
          <div class="">
            <button class="project1-btn">
              View more
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <div class="project-img2">
        <img src="/project-2.png" alt="project-2" loading="lazy" />
      </div>

      <div class="project-img3">
        <img src="/project-3.png" alt="project-3" loading="lazy" />
      </div>

      <div class="project-img4">
        <img src="/project-4.png" alt="project-4" loading="lazy" />
      </div>

      <div class="project-img5">
        <img src="/project-5.png" alt="project-5" loading="lazy" />
      </div>
    </div>
  ...
  <section class="section container contact-us">
    ...
    <button class="btn contact-us_btn" type="submit">
      Send Email
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
